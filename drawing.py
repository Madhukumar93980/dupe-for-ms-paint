...
class Draw():
    def __init__(self,root):
        self.root =root
        self.root.title("Assignment Painter")
        ...
        text=Text(root)
        text.tag_configure("tag_name", justify='center', font=('arial',20),background='#292826',foreground='orange')
        ...
        self.pick_color.place(x=0,y=40,width=70,height=185)

        colors = ['blue','red','green', 'orange','violet','yellow','purple','pink','gold','brown','indigo']
        i=j=0
        for color in colors:
